...
2024-01-12
问题1：已经进入编辑状态，还会走到用户鼠标未操作的判断逻辑，设备不时收到 operaPreview 的关闭请求；
问题2：operaCameraLens previewType = 0，1 的 period = 1000，应该等于 66；
问题3：operaCameraLens previewType = 0，1 时，都没有主动发过停止，导致设备持续发画面过去；
